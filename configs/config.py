...
CLIP_VIT_B32_PATH = '/replicate/ViT-B-32.pt'
...
DATASETS = {
    ...
    'k400': dict(
        TRAIN_ROOT=r'Kinetics-400\videos_train',
        VAL_ROOT=r'Kinetics-400\videos_val',
        TRAIN_LIST='k400_train.txt',
        VAL_LIST='k400_val.txt',
        NUM_CLASSES=400,
    ),
    'k400_128st': dict(
        TRAIN_ROOT='',
